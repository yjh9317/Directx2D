...
void TileMapTex::render_update()
{
	...
	ImGui::Text("Grid");
	ImGui::SameLine();
	ImGui::RadioButton("On", &b, 1);
	ImGui::SameLine();
	ImGui::RadioButton("Off", &b, 0);
	...
	ImGui::Text("IdxCheck");
	ImGui::SameLine();
	ImGui::RadioButton("On##Idx", &d, 1);
	ImGui::SameLine();
	ImGui::RadioButton("Off##Idx", &d, 0);
...
void TileMapTex::RTTex()
{
	...
	if (ImGui::IsMouseDown(1))
	{
		...
		//if (x - TileLeft < 0) IdxX = 0;
		//if (y - TileTop < 0) IdxX = 0;
...
void TileMapTex::AddCollider()
{
	...
	if (ImGui::Button("Add Collider"))
	{
		...
		pChildObj->Transform()->SetRelativePos(Vec3(0.f, 0.f, 10.f));
...
void TileMapTex::CheckColliderIdx()
{
	...
	//ImGui::SetCursorPos(ImVec2(780.f, 1000.f));
	//ImGui::Text("End_row");
	//ImGui::SameLine();
	//ImGui::InputInt("##end_row", &end_row, 0, 0, ImGuiInputTextFlags_::ImGuiInputTextFlags_ReadOnly);


	//ImGui::SameLine();
	//ImGui::Text("End_col");
	//ImGui::SameLine();
	//ImGui::InputInt("##end_col", &end_col, 0, 0, ImGuiInputTextFlags_::ImGuiInputTextFlags_ReadOnly);
